...
<body>
	...
	<div id="first">
		...
		<div class="d2"><p>当前角色:<span class="s1">{{$data->name}}</span>的权限信息</p></div>
	</div>
	<form  class="form form-horizontal" id="form-admin-role" action="/adminrolelist/{{$data->id}}" method="post">
	<div id="second">
		<div id="d1"></div>
		<div id="d2" style="text-align:left">
				...
				success: function(data){
					...
					setTimeout(function(){
					 window.parent.location.reload()}, 1500);
				  	...
				  	layer.msg('角色修改失败!',{icon:2,time:1000});
				  }
				},
