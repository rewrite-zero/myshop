        ...
        <div id="featureContainer1">
            <div style="margin-top:10px">
                ...
                <form action="javascript:void(0)" method="get"> 
                    ...
                    <button id="tt">提交</button>
                </form>
        </div>
            <div style="margin-top:10px;width:700px;border:1px solid">
                <span style="font-weight:777;font-size:16px;float:left">标题</span>
                <span style="font-weight:777;font-size:16px;float:right">时间</span>
            </div>
            <div id="find">
...
$('#tt').click(function(){
    //获取输入的值
    ipt = $(this).prev('input').val();
    // alert(ipt);
    $.get('/articlefind',{ipt:ipt},function(data){
        //替换内容
          $('#find').html(data);
    });
});
